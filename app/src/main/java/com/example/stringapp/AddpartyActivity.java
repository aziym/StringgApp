...
public class AddpartyActivity extends AppCompatActivity {
    ...
    Button saveButton;
    EditText uploadTopic, uploadDesc, uploadDateTime;
    String imageURL;
    Uri uri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadDateTime = findViewById(R.id.uploadDateTime);
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if(result.getResultCode() == Activity.RESULT_OK){
                            ...
                            Toast.makeText(AddpartyActivity.this, "No Image Selected", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
    ...
    public void saveData(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddpartyActivity.this);
    ...
    public void uploadData(){
        ...
        String datetime = uploadDateTime.getText().toString();
        ...
        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(AddpartyActivity.this, "Saved", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AddpartyActivity.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}